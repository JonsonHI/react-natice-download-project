/*
 * @Author: Jonson 
 * @Date: 2022-05-21 15:41:26 
 * @Last Modified by:   Jonson 
 * @Last Modified time: 2022-05-21 15:41:26 
 */
    ...
    return (
      <View style={[styles.container, errorStyle]}>
        {/* <Image
          ...
          source={imageSource ? imageSource : Images.errorImage}
        /> */}
        <Text style={[styles.errorTitle, errorTitleStyle]}>{title}</Text>
        {/* <Button
